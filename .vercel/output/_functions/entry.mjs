...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_JbdfTUGY.mjs';
import { manifest } from './manifest_CUqR_KDp.mjs';
...
const _args = {
    "middlewareSecret": "b9a5f6a5-96df-4520-85f8-1dd1ecef23a4",
